    ...
    <div>
      <main>
        ...
        <section className='lg:py-[80px] lg:px-[120px] sm:p-[24px]'>
          ...
          <div className='flex justify-center items-center lg:py-[20px] gap-[20px] sm:flex-wrap'>
            <Card5 h1={"05 Aug"} p={"11:00 – 14:00"} span={"Onine master-class"} btn={"View more"} h2={"Formation of the organizational structure of the company in the face of uncertainty."} />
            <Card5 h1={"05 Aug"} p={"11:00 – 14:00"} span={"Onine master-class"} btn={"View more"} h2={"Formation of the organizational structure of the company in the face of uncertainty."} />
            <Card5 h1={"05 Aug"} p={"11:00 – 14:00"} span={"Onine master-class"} btn={"View more"} h2={"Formation of the organizational structure of the company in the face of uncertainty."} />
            <Card5 h1={"05 Aug"} p={"11:00 – 14:00"} span={"Onine master-class"} btn={"View more"} h2={"Formation of the organizational structure of the company in the face of uncertainty."} />
            <Card5 h1={"05 Aug"} p={"11:00 – 14:00"} span={"Onine master-class"} btn={"View more"} h2={"Formation of the organizational structure of the company in the face of uncertainty."} />
